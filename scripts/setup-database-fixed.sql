-- AuraTrack Database Setup - Versión Corregida
...
-- Crear índices básicos (sin GIN problemático)
...
-- Índice simple para aura (sin GIN)
CREATE INDEX IF NOT EXISTS idx_migraine_entries_aura 
...
SELECT table_name FROM information_schema.tables WHERE table_schema = 'public' AND table_name IN ('app_users', 'migraine_entries');
